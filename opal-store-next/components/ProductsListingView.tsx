    ...
    <div className="pt-[70px] min-h-screen">
      ...
      <div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <h1 className="font-display text-4xl font-semibold text-gold">{pageTitle}</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        {products.length > 0 ? (
          ...
          <div className="text-center py-24">
            <svg className="w-16 h-16 mx-auto mb-6 text-muted-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <h3 className="font-display text-2xl text-muted-2 mb-2">No products found</h3>
            ...
            <Link href="/products"
              className="inline-block border border-gold text-gold px-6 py-2 text-sm rounded-[var(--radius-btn)] btn-3d hover:bg-gold hover:text-white transition-all duration-300">
              Browse All Products
            </Link>
          </div>
        )}
